...
class Dimensions {
  ...
  static double height6 = screenHeight / 130.18;
  ...
  static double height32 = screenHeight / 24.41;
  ...
  static double height121 = screenHeight / 6.46;
  ...
  static double width4 = screenWidth / 98.18;
  ...
  static double width25 = screenWidth / 15.71;
  static double width30 = screenWidth / 13.09;
  static double width32 = screenWidth / 12.27;
  ...
  static double font40 = screenHeight / 19.53;
  ...
  //list view size
  static double listViewImgSize = screenWidth / 3.27; // width120
  static double listViewTextContSize = screenWidth / 3.93; // width100

  // Cuisines Banner Size
  static double cuisinesBannerImgSize = screenHeight / 6.51;
}
