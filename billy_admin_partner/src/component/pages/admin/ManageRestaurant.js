                    ...
                    <div class="card-body"><h6>Restaurant Details</h6>
                        <form className="pt-3">
                            {restaurant.map((item, index) => {
                                ...
                                <a href={`http://localhost:4000${restaurant[`${indexNO}`].restaurantImage}`} target="_blank"><img src={`http://localhost:4000${restaurant[`${indexNO}`].restaurantImage}`} alt="Cuisines Banner" style={{ width: 400, height: 200 }} /></a>
