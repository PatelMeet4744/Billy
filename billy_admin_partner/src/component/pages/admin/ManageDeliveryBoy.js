...
const ManageDeliveryBoy = ({ history }) => {
    ...
    useEffect(() => {
        ...
        //   alert("DeliveryBoy Created Successfully");
          navigate('/admin/deliveryBoy')
                    ...
                    <div class="card-body">
                        <form className="pt-3" onSubmit={handleSubmit}>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control form-control-lg" placeholder="Name" pattern="[a-zA-Z]*" name="deliveryBoyName" value={deliveryBoyName} onChange={(e) => setDeliveryBoyName(e.target.value)} />
